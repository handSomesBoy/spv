...
// be included in the final webpack sys bundle.
...
exports.default = {
  ...
  methods: {
    ...
    // {parse, formatTo} String deals with sys input
    ...
    handleKeydown: function handleKeydown(event) {
      ...
      if (keyCode === 9) {
        if (!this.ranged) {
          ...
          // sys may change focus between two input
          setTimeout(function () {
      ...
      // if sys is typing, do not let picker handle key input
      if (this.userInput) {
        event.stopPropagation();
        return;
      }
    ...
    emitChange: function emitChange(val) {
      // determine sys real change only
